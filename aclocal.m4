...
#  NLS Support
#
#  Add the GETTEXT macros here
#   We depend on having:
#     USE_NLS - set to use nls
#     USE_INCLUDED_LIBINTL
#
#  Put this code after the AM_USE_NLS macro in the configure.in file:
#  if test ${USE_NLS} = yes; then
#    if test -n "${USE_INCLUDED_LIBINTL}" ; then
#       INTLINCS='$(top_builddir)/intl'
#       AC_SUBST(INLINCS)
#    else
#       INTLLIBS=-lintl
#       AC_SUBST(INTLLIBS)
