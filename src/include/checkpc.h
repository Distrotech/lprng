...
static void Check_executable_filter( char *id, char *filter_str );
...
static int Check_read_file( char  *path, int fix, int perms, int owner );
...
static int Check_spool_dir( char *path, int owner );
